...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public partial class GreenNodeTests
    {
        ...
        private static Syntax.InternalSyntax.UsingDirectiveSyntax GenerateUsingDirective()
            => InternalSyntaxFactory.UsingDirective(null, null, null, null, GenerateIdentifierName(), InternalSyntaxFactory.Token(SyntaxKind.SemicolonToken));
        ...
        private static Syntax.InternalSyntax.DelegateDeclarationSyntax GenerateDelegateDeclaration()
            => InternalSyntaxFactory.DelegateDeclaration(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.AttributeListSyntax>(), new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.SyntaxToken>(), InternalSyntaxFactory.Token(SyntaxKind.DelegateKeyword), InternalSyntaxFactory.Identifier("Identifier"), null, GenerateParameterList(), GenerateIdentifierName(), new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.TypeParameterConstraintClauseSyntax>(), null);
        ...
        private static Syntax.InternalSyntax.PropertyDeclarationSyntax GeneratePropertyDeclaration()
            => InternalSyntaxFactory.PropertyDeclaration(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.AttributeListSyntax>(), new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.SyntaxToken>(), null, InternalSyntaxFactory.Identifier("Identifier"), GenerateIdentifierName(), null, null, null, null);
        ...
        private static Syntax.InternalSyntax.EventDeclarationSyntax GenerateEventDeclaration()
            => InternalSyntaxFactory.EventDeclaration(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.AttributeListSyntax>(), new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.SyntaxToken>(), InternalSyntaxFactory.Token(SyntaxKind.EventKeyword), null, InternalSyntaxFactory.Identifier("Identifier"), GenerateIdentifierName(), null, null);

        private static Syntax.InternalSyntax.IndexerDeclarationSyntax GenerateIndexerDeclaration()
            => InternalSyntaxFactory.IndexerDeclaration(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.AttributeListSyntax>(), new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<Syntax.InternalSyntax.SyntaxToken>(), null, InternalSyntaxFactory.Token(SyntaxKind.ThisKeyword), GenerateBracketedParameterList(), GenerateIdentifierName(), null, null, null);
        ...
        public void TestForEachStatementFactoryAndProperties()
        {
            ...
            Assert.Null(node.EqualsGreaterThanToken);
            Assert.NotNull(node.Statement);
        ...
        public void TestUsingDirectiveFactoryAndProperties()
        {
            ...
            Assert.Null(node.ImportKeyword);
            Assert.Null(node.UsingKeyword);
        ...
        public void TestNamespaceDeclarationFactoryAndProperties()
        {
            ...
            Assert.NotNull(node.Name);
            Assert.Null(node.PostNameSemicolonToken);
    ...
    public partial class RedNodeTests
    {
        ...
        private static LocalFunctionStatementSyntax GenerateLocalFunctionStatement()
            => SyntaxFactory.LocalFunctionStatement(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), SyntaxFactory.Identifier("Identifier"), default(TypeParameterListSyntax), GenerateParameterList(), GenerateIdentifierName(), new SyntaxList<TypeParameterConstraintClauseSyntax>(), default(BlockSyntax), default(ArrowExpressionClauseSyntax), default(SyntaxToken));
        ...
        private static ForEachStatementSyntax GenerateForEachStatement()
            => SyntaxFactory.ForEachStatement(new SyntaxList<AttributeListSyntax>(), default(SyntaxToken), SyntaxFactory.Token(SyntaxKind.ForEachKeyword), default(SyntaxToken), SyntaxFactory.Identifier("Identifier"), GenerateIdentifierName(), SyntaxFactory.Token(SyntaxKind.InKeyword), GenerateIdentifierName(), default(SyntaxToken), default(SyntaxToken), GenerateBlock());

        private static ForEachVariableStatementSyntax GenerateForEachVariableStatement()
            => SyntaxFactory.ForEachVariableStatement(new SyntaxList<AttributeListSyntax>(), default(SyntaxToken), SyntaxFactory.Token(SyntaxKind.ForEachKeyword), default(SyntaxToken), GenerateIdentifierName(), SyntaxFactory.Token(SyntaxKind.InKeyword), GenerateIdentifierName(), default(SyntaxToken), default(SyntaxToken), GenerateBlock());
        ...
        private static UsingDirectiveSyntax GenerateUsingDirective()
            => SyntaxFactory.UsingDirective(default(SyntaxToken), default(SyntaxToken), default(SyntaxToken), default(NameEqualsSyntax), GenerateIdentifierName(), SyntaxFactory.Token(SyntaxKind.SemicolonToken));
        ...
        private static DelegateDeclarationSyntax GenerateDelegateDeclaration()
            => SyntaxFactory.DelegateDeclaration(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), SyntaxFactory.Token(SyntaxKind.DelegateKeyword), SyntaxFactory.Identifier("Identifier"), default(TypeParameterListSyntax), GenerateParameterList(), GenerateIdentifierName(), new SyntaxList<TypeParameterConstraintClauseSyntax>(), default(SyntaxToken));
        ...
        private static MethodDeclarationSyntax GenerateMethodDeclaration()
            => SyntaxFactory.MethodDeclaration(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), default(ExplicitInterfaceSpecifierSyntax), SyntaxFactory.Identifier("Identifier"), default(TypeParameterListSyntax), GenerateParameterList(), GenerateIdentifierName(), new SyntaxList<TypeParameterConstraintClauseSyntax>(), default(BlockSyntax), default(ArrowExpressionClauseSyntax), default(SyntaxToken));
        ...
        private static PropertyDeclarationSyntax GeneratePropertyDeclaration()
            => SyntaxFactory.PropertyDeclaration(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), default(ExplicitInterfaceSpecifierSyntax), SyntaxFactory.Identifier("Identifier"), GenerateIdentifierName(), default(AccessorListSyntax), default(ArrowExpressionClauseSyntax), default(EqualsValueClauseSyntax), default(SyntaxToken));
        ...
        private static EventDeclarationSyntax GenerateEventDeclaration()
            => SyntaxFactory.EventDeclaration(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), SyntaxFactory.Token(SyntaxKind.EventKeyword), default(ExplicitInterfaceSpecifierSyntax), SyntaxFactory.Identifier("Identifier"), GenerateIdentifierName(), default(AccessorListSyntax), default(SyntaxToken));

        private static IndexerDeclarationSyntax GenerateIndexerDeclaration()
            => SyntaxFactory.IndexerDeclaration(new SyntaxList<AttributeListSyntax>(), new SyntaxTokenList(), default(ExplicitInterfaceSpecifierSyntax), SyntaxFactory.Token(SyntaxKind.ThisKeyword), GenerateBracketedParameterList(), GenerateIdentifierName(), default(AccessorListSyntax), default(ArrowExpressionClauseSyntax), default(SyntaxToken));
        ...
        public void TestFunctionPointerTypeFactoryAndProperties()
        {
            ...
            Assert.Equal(default, node.Parameters);
            Assert.Equal(SyntaxKind.GreaterThanToken, node.GreaterThanToken.Kind());
            var newNode = node.WithDelegateKeyword(node.DelegateKeyword).WithAsteriskToken(node.AsteriskToken).WithCallingConvention(node.CallingConvention).WithLessThanToken(node.LessThanToken).WithParameters(node.Parameters).WithGreaterThanToken(node.GreaterThanToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestLocalFunctionStatementFactoryAndProperties()
        {
            ...
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithIdentifier(node.Identifier).WithTypeParameterList(node.TypeParameterList).WithParameterList(node.ParameterList).WithReturnType(node.ReturnType).WithConstraintClauses(node.ConstraintClauses).WithBody(node.Body).WithExpressionBody(node.ExpressionBody).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestForEachStatementFactoryAndProperties()
        {
            ...
            Assert.Equal(SyntaxKind.None, node.EqualsGreaterThanToken.Kind());
            Assert.NotNull(node.Statement);
            var newNode = node.WithAttributeLists(node.AttributeLists).WithAwaitKeyword(node.AwaitKeyword).WithForEachKeyword(node.ForEachKeyword).WithOpenParenToken(node.OpenParenToken).WithIdentifier(node.Identifier).WithType(node.Type).WithInKeyword(node.InKeyword).WithExpression(node.Expression).WithCloseParenToken(node.CloseParenToken).WithEqualsGreaterThanToken(node.EqualsGreaterThanToken).WithStatement(node.Statement);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestUsingDirectiveFactoryAndProperties()
        {
            ...
            Assert.Equal(SyntaxKind.None, node.ImportKeyword.Kind());
            Assert.Equal(SyntaxKind.None, node.UsingKeyword.Kind());
            Assert.Equal(SyntaxKind.None, node.StaticKeyword.Kind());
            Assert.Null(node.Alias);
            Assert.NotNull(node.Name);
            Assert.Equal(SyntaxKind.SemicolonToken, node.SemicolonToken.Kind());
            var newNode = node.WithImportKeyword(node.ImportKeyword).WithUsingKeyword(node.UsingKeyword).WithStaticKeyword(node.StaticKeyword).WithAlias(node.Alias).WithName(node.Name).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestNamespaceDeclarationFactoryAndProperties()
        {
            ...
            Assert.Equal(SyntaxKind.NamespaceKeyword, node.NamespaceKeyword.Kind());
            Assert.NotNull(node.Name);
            Assert.Equal(SyntaxKind.None, node.PostNameSemicolonToken.Kind());
        ...
        public void TestDelegateDeclarationFactoryAndProperties()
        {
            ...
            Assert.Equal(default, node.ConstraintClauses);
            Assert.Equal(SyntaxKind.None, node.SemicolonToken.Kind());
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithDelegateKeyword(node.DelegateKeyword).WithIdentifier(node.Identifier).WithTypeParameterList(node.TypeParameterList).WithParameterList(node.ParameterList).WithReturnType(node.ReturnType).WithConstraintClauses(node.ConstraintClauses).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestMethodDeclarationFactoryAndProperties()
        {
            ...
            Assert.Null(node.ExpressionBody);
            Assert.Equal(SyntaxKind.None, node.SemicolonToken.Kind());
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithExplicitInterfaceSpecifier(node.ExplicitInterfaceSpecifier).WithIdentifier(node.Identifier).WithTypeParameterList(node.TypeParameterList).WithParameterList(node.ParameterList).WithReturnType(node.ReturnType).WithConstraintClauses(node.ConstraintClauses).WithBody(node.Body).WithExpressionBody(node.ExpressionBody).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestPropertyDeclarationFactoryAndProperties()
        {
            ...
            Assert.Null(node.Initializer);
            Assert.Equal(SyntaxKind.None, node.SemicolonToken.Kind());
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithExplicitInterfaceSpecifier(node.ExplicitInterfaceSpecifier).WithIdentifier(node.Identifier).WithType(node.Type).WithAccessorList(node.AccessorList).WithExpressionBody(node.ExpressionBody).WithInitializer(node.Initializer).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestEventDeclarationFactoryAndProperties()
        {
            ...
            Assert.Null(node.AccessorList);
            Assert.Equal(SyntaxKind.None, node.SemicolonToken.Kind());
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithEventKeyword(node.EventKeyword).WithExplicitInterfaceSpecifier(node.ExplicitInterfaceSpecifier).WithIdentifier(node.Identifier).WithType(node.Type).WithAccessorList(node.AccessorList).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
        ...
        public void TestIndexerDeclarationFactoryAndProperties()
        {
            ...
            Assert.Null(node.ExpressionBody);
            Assert.Equal(SyntaxKind.None, node.SemicolonToken.Kind());
            var newNode = node.WithAttributeLists(node.AttributeLists).WithModifiers(node.Modifiers).WithExplicitInterfaceSpecifier(node.ExplicitInterfaceSpecifier).WithThisKeyword(node.ThisKeyword).WithParameterList(node.ParameterList).WithType(node.Type).WithAccessorList(node.AccessorList).WithExpressionBody(node.ExpressionBody).WithSemicolonToken(node.SemicolonToken);
            Assert.Equal(node, newNode);
        }
