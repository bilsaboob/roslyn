...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
    ...
    public readonly struct SyntaxToken : IEquatable<SyntaxToken>
    {
        ...
        internal static readonly Func<SyntaxToken, bool> NonZeroWidthOrFake = t => t.Width > 0 || (t.RawKind >= 8193 && t.RawKind <= 8223); /* allow all C# punctuation tokens ... even if they are "fake" ... */
